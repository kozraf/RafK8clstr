...
#
sudo echo '/srv/nfs/k8s 192.168.89.142(rw,sync,no_subtree_check,no_root_squash) 192.168.89.143(rw,sync,no_subtree_check,no_root_squash)' | sudo tee -a /etc/exports
